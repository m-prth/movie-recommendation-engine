...
print("Scraping IMDB for movie data...")
movie_name = []
year = []
time=[]
rating=[]
...
for page in pages:
    ...
    page = requests.get("https://www.imdb.com/search/title/?title_type=feature&primary_language=en&ref_=adv_prv"+str(page)+"&ref_=adv_nxt")
    print("Response received with status code: " + str(page.status_code))
